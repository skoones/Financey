...
@Component({
  selector: 'app-single-budget-analysis',
  templateUrl: './single-budget-analysis.component.html',
  styleUrls: ['./single-budget-analysis.component.scss']
})
export class SingleBudgetAnalysisComponent implements OnInit {
